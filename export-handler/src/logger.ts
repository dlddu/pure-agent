// Synced copy: also exists in mcp-server/src/logger.ts — keep both in sync.
// If you change this file, apply the same change to mcp-server/src/logger.ts.
// A shared package is not used because the project does not use npm workspaces.
