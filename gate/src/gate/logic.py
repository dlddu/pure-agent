"""Core gate logic: decision functions and file operations."""
...
def should_continue(
    config: GateConfig, export_config_json: str, depth: int, max_depth: int
) -> tuple[bool, str]:
    """Decide whether the agent loop should continue.

    Args:
        config: Gate configuration (file paths).
