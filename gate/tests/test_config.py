...
class TestTranscriptUploadConfig:
    ...
    def test_from_env_endpoint_url_none_when_not_set(self, monkeypatch):
        monkeypatch.setenv("AWS_S3_BUCKET_NAME", "my-bucket")
    ...
    def test_from_env_endpoint_url_none_when_empty(self, monkeypatch):
        monkeypatch.setenv("AWS_S3_BUCKET_NAME", "my-bucket")
    ...
    def test_from_env_endpoint_url_when_set(self, monkeypatch):
        monkeypatch.setenv("AWS_S3_BUCKET_NAME", "my-bucket")
